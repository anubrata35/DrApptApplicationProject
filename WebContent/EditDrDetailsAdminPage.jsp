...
<script>
	function changeOption() {
		document.forms[0].action = "./OnChangeUpdateDrServlet";
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-15">
				...
				<br> <br> <br>
				<form action="<%=request.getContextPath()%>/OnChangeUpdateDrServlet">
					<div>
						<center>
							<label for="sel1" id="optTitle"
								style="color: blue; font-size: 14pt; font-weight: bold;">Select
								City</label>
						</center>
						<select name="city" id="sel1" class="form-control"
							style="font-size: 12pt; color: brown; font-weight: bold;">
							<option value="0" class="optValue" disabled="disabled"
								selected="selected" class="optionStyle">Select City</option>
					...
					<div>
						...
						<select name="hospital" id="sel2" class="form-control"
							style="font-size: 12pt; color: brown; font-weight: bold;">
							<option value="0" class="optValue" disabled="disabled"
								selected="selected" class="optionStyle">Select Hospital</option>
					...
					<center>
						<b><button type="submit" onclick="changeOption()"
								class="btn btn-info">
				...
				<hr>
				<center>
					<form action="<%=request.getContextPath()%>/UpdateDrDetailsServlet">
						<table class="table" style="padding: 8px">
							<thead style="color: darkblue; font-size: 14pt">
								<tr>
									...
									<th>Specialist</th>
									<th>Dr Chember</th>
									<th>Select this Dr for Appointment</th>
								</tr>
							</thead>
							<%
							...
							<tbody style="color: black;">
								<tr>
									...
									<td class="drSelect"><b><input type="radio"
											name="selectDoctor" value="<%=drName%>"> Select Dr</b></input></td>
								</tr>
							</tbody>
							<%
								}
