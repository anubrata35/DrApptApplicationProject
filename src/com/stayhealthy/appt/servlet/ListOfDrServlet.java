...
@WebServlet("/ListOfDrServlet")
public class ListOfDrServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	Logger logger = Logger.getLogger(ListOfDrServlet.class);
	...
	public void customeMethod(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("viewAllDrList.jsp").forward(request, response);
